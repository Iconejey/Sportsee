		...
		return (
			<div className="dashboard-container">
				<aside className="sidebar">
					<img src="/logo.png" alt="Sportsee" className="sidebar-logo" />
					...
					<div className="sidebar-copyright">Copyright Sportsee 2026</div>
				</aside>
				...
				<main className="main-content">
					<div className="header-row">
						<div>
							<h1 className="user-welcome-title">
								Bonjour <span className="user-name-highlight">{user.profile.firstName}</span>
							</h1>
							<p className="welcome-subtitle">Félicitations ! Vous avez explosé vos objectifs hier 👏</p>
						</div>
					...
					<div className="stats-and-profile-grid">
						<div className="stats-grid">
							<div className="stat-card">
								<div className="stat-icon-container distance">🏃</div>
								<div className="stat-info">
									<span className="stat-value">{user.statistics.totalDistance} km</span>
									<span className="stat-label">Distance totale</span>
								</div>
							</div>

							<div className="stat-card">
								<div className="stat-icon-container sessions">📅</div>
								<div className="stat-info">
									<span className="stat-value">{user.statistics.totalSessions}</span>
									<span className="stat-label">Sessions de sport</span>
								</div>
							</div>

							<div className="stat-card">
								<div className="stat-icon-container duration">⏱️</div>
								<div className="stat-info">
									<span className="stat-value">{user.statistics.totalDuration} min</span>
						...
						<div className="profile-card">
							<img src={user.profile.profilePicture || '/logo.png'} alt={`${user.profile.firstName} ${user.profile.lastName}`} className="profile-avatar" />
							<h2 className="profile-name">
								{user.profile.firstName} {user.profile.lastName}
							</h2>
							<p className="welcome-subtitle" style={{ marginBottom: '20px' }}>
								Membre depuis {new Date(user.profile.createdAt).toLocaleDateString('fr-FR')}
							</p>

							<div className="profile-info-grid">
								<div className="info-item">
									<span className="info-value">{user.profile.age}</span>
									<span className="info-label">Âge</span>
								</div>
								<div className="info-item">
									<span className="info-value">{user.profile.weight}kg</span>
									<span className="info-label">Poids</span>
								</div>
								<div className="info-item">
									<span className="info-value">{user.profile.height}cm</span>
